  ...
  return (
    <main className="flex flex-col gap-6">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="rounded-xl bg-white dark:bg-gray-800 shadow-card p-6 flex flex-col items-start">
      ...
      <div className="rounded-xl bg-white dark:bg-gray-800 shadow-card p-6 mt-4">
